...
public class Tile : MonoBehaviour
{
    ...
    //Настроить колайдер этой плитки
    void SetCollider()
    {
        //Получить информацию о колайдере из Collider DelverCollisions.txt
        bColl.enabled = true;
        char c = TileCamera.COLLISION[tileNum];
        switch (c)
        {
            case 'S'://Вся плитка
            ...
            case 'D'://Правая половина
                ...
                bColl.size = new Vector3(0.5f, 1, 1);
                break;
            //vvvvvvvvv----------Дополнительные коды-----------vvvvvvvvv
