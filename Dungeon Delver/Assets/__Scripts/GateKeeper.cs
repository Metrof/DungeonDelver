...
{
    //Следующие константы зависят от файда изображения по умолчанию DelverTiles
    //Если вы переупорядочите спрайты в DelverTiles,
    //возможно, вам придется изменить эти константы!
    //-------------Индекс плиток с запертыми дверьми
    ...
    //-------------Индекс плиток с открытыми дверьми
    const int openR = 48;
    const int openUR = 93;
    const int openUL = 92;
    const int openL = 51;
    ...
    {
        //Если ключей нет, то можно не продолжать
